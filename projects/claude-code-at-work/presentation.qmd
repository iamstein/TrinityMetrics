...
## xgxr: Source of bug: we used a hand-copied "fork" of ggplot2 (now outdated)
...
Once I have an algorithm that works well and can is acceptable by our data privacy office, I'll then validate the code, but to this point, it's all been "vibe-coded" with Claude Code.  

It's been helpful having a working prototype for building my own understanding and in discussions with others.
...
## 4. Output (so far) a specification. 
...
## Claude and I build websites in GitHub for development

- For an R package, `pkgdown`. For anything else, Quarto and `quarto_render()`.
...
For things that aren't their own R package and github repo, I've been using
...
3. **I can control Claude Code from my phone, my home machine, or my work machine**
   with `/remote-control`.
4. **I can use the latest Claude models (Fable).** Though it kicked me back
