...
* When and why I use Claude Code rather than Positron + GitHub Copilot
* How I set up Claude Code
* Four pieces of open-source work I did using Claude Code

# When and why I use Claude Code

## Advantages of Claude Code over Positron + GitHub Copilot

1. **I can use the latest Claude models (Fable).** 
2. **I can control Claude Code from my phone, my home machine, or my work machine**
   with `/remote-control`.
3. **Claude Code runs on my personal machine at home, using ordinary GitHub.** No confusion with the GitHub Copilot setup and corporate Github account.
4. **Claude Code runs longer and requires less input from user**  But, better positron settings (Auto) might help (?).
