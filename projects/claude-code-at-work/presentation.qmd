...
## xgxr: Actual problem: used hand-copied "fork" of ggplot2
...
## xgxr: The key line causing the error
...
3. Give it a small task, and ask it to use GitHub Actions to set up a website
   and publish the results
4. Have it publish the site, and read the output
