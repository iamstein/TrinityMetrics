...
**Two axes, not one.** The saving can arrive as calendar time or as
patients, and a design can win on one without the other. Catch-up
escalation is expected to be exactly that case: little change in
$T_{3,\rm eval}$, substantially less patient-time at clearly subactive
doses (Section 6). An objective stated on time alone scores that design
as a failure when it is not one.

The two headline quantities are therefore:
...
visits, doses, hospital days and patients into a single number requires
...
Section 5 keeps the list short. The two quantities above are the
headline pair because they are what a programme argues about; the rest
stay components.
